...
<link href="/css/note/detail.css" rel="stylesheet" type="text/css" />
				...
				<article>
					...
					<footer class="footer">
						...
						<span class="item-count-box">
							...
							<a href="" class="c-symbol c-symbol-like c-symbol-color text-strong mr-3">${n.likeCount}</a>
							<a href="" class="c-symbol c-symbol-bookmark c-symbol-color text-strong mr-3">${n.bookMarkCount}</a>
							<span class="item-count hit-count c-symbol-color">${n.hit}</span>
						</span>
					</footer>
				...
				<section class="">
					...
					<ul>
						...
						<c:set var="likeStyle" value="${likeStatus?'c-symbol-color':'' }" />
							<a href="${n.id}/like" class="c-symbol c-symbol-like ${likeStyle} text-strong mr-3">${n.likeCount}</a>
							<a href="" class="c-symbol c-symbol-bookmark c-symbol-color text-strong mr-3">${n.bookMarkCount}</a>
						</li>
					</ul>
				</section>
	...
	<script src="/js/note/detail.js"></script>
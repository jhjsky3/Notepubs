	...
	<div id="body">
		<section class="content-section ml-auto mr-auto first">
			...
			<form class="login-form" action="login" method="post">
				<fieldset>
					<legend class="d-none">비밀번호 찾기 필드</legend>
					<span>
						<label>아이디</label>
						<input type="text" name="uid" placeholder="가입할 때 기입한 아이디를 입력하세요">
					</span>	
					<span>
						<label>이메일주소</label>
					...
					<span>
						<input type="submit" value="이메일로 임시 번호를 전달해주세요">					
						<span class="join-button mt-3 text-align-center">
							<a href="login">로그인 다시 시도</a> / <a href="find-pwd">아이디 찾기</a>
						</span>
